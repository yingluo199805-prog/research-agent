...
| 2. Build and deploy dashboard | `src/dashboard_build/gen_data*.py`, `build.py`, `scripts/build-dashboard.ps1`, `scripts/deploy-dashboard.ps1` | three aggregates, generated `dashboard.html`, Vercel production deployment | Generated JSON and HTML are ignored by Git. |
